/* ============================================
   COMPLETE POLISHED CSS FOR ROCK PAPER SCISSORS
   ============================================ */
...
/* ===== GLOW TEXT ===== */
.glow-text {
    text-shadow: 0 0 20px rgba(124, 58, 237, 0.5), 0 0 60px rgba(124, 58, 237, 0.3);
}
...
/* ===== CAMERA BOX & COMPUTER BOX - SAME SIZE ===== */
.camera-box,
.computer-hand-box {
    border-radius: 25px;
    overflow: hidden;
...
.computer-hand-box.shaking {
    border-color: #4facfe;
    box-shadow: 0 0 40px rgba(79, 172, 254, 0.3);
    animation: glowPulseBlue 0.8s ease-in-out infinite;
}

.camera-box.winner,
.computer-hand-box.winner {
    border-color: #4ade80;
    box-shadow: 0 0 60px rgba(74, 222, 128, 0.4);
    animation: glowPulseGreen 0.6s ease-in-out infinite;
}

.camera-box.loser,
.computer-hand-box.loser {
    border-color: #f87171;
...
/* ===== SHAKE ANIMATION ===== */
.camera-shake {
    animation: shakeHand 0.3s ease-in-out infinite;
}
...
.battle-card.winner-card {
    border-color: #4ade80;
    box-shadow: 0 0 50px rgba(74, 222, 128, 0.2);
}

.battle-card.loser-card {
    border-color: #f87171;
    box-shadow: 0 0 50px rgba(248, 113, 113, 0.15);
}
...
.battle-hand {
    ...
    display: inline-block;
    margin: 15px;
    animation: revealHand 0.6s ease;
}
...
.score-card:nth-child(1) h2 {
    color: #fbbf24;
}
.score-card:nth-child(2) h2 {
    color: #f87171;
}
.score-card:nth-child(3) h2 {
    color: #60a5fa;
}
...
/* ===== MANUAL MODE SHAKE ===== */
.shake-player {
    animation: playerShake 0.4s ease-in-out infinite;
}

.shake-computer {
    animation: computerBattleShake 0.4s ease-in-out infinite;
}
